					...
					style={
						{
							...
							"--gradient":
								variant === "white"
									...
									: color
										? `radial-gradient(circle, ${color} 10%, ${color}00 20%), radial-gradient(circle at 40% 40%, #ffffff 5%, #ffffff00 15%), radial-gradient(circle at 60% 60%, ${color} 10%, ${color}00 20%), radial-gradient(circle at 40% 60%, #ffffff 10%, #ffffff00 20%), repeating-conic-gradient(from 236.84deg at 50% 50%, ${color} 0%, #ffffff calc(25% / var(--repeating-conic-gradient-times)), ${color} calc(50% / var(--repeating-conic-gradient-times)), #ffffff calc(75% / var(--repeating-conic-gradient-times)), ${color} calc(100% / var(--repeating-conic-gradient-times)))`
